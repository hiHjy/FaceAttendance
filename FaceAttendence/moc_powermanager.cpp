...
QT_MOC_LITERAL(1, 13, 17), // "powerStatusChange"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5), // "State"
QT_MOC_LITERAL(4, 38, 22) // "backlightStatusChanged"

    },
    "PowerManager\0powerStatusChange\0\0State\0"
...
void PowerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->powerStatusChange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->backlightStatusChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PowerManager::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PowerManager::powerStatusChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PowerManager::powerStatusChange(bool _t1)
{
